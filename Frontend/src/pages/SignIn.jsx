...
//             className={`px-4 py-2 rounded-l-lg ${role === 'user' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} font-semibold focus:outline-none`}
//           >
//             User
//           </button>
//           <button
//             onClick={() => handleRoleChange('admin')}
//             className={`px-4 py-2 rounded-r-lg ${role === 'admin' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} font-semibold focus:outline-none`}
//           >
//             Admin
//           </button>
//         </div>
...
//           >
//             {loading ? 'Logging in...' : `Sign In as ${role === 'admin' ? 'Admin' : 'User'}`}
//           </button>
//         </form>
//       </div>
//     </div>
...
//             <Link
//               to="/"
//               className="text-gray-700 hover:border-b-2 hover:border-blue-500 py-1 transition-all"
//             >
//               Home
//             </Link>
//             <Link
