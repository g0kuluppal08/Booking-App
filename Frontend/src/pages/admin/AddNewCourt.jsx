...
//   // Fetch court data (Example API)
//   useEffect(() => {
//     const fetchCourtData = async () => {
//       try {
//         const response = await fetch("/api/admin/getCourts", {
//           method: "GET",
//           headers: {
...
//           if (response.ok) {
//             const data = await response.json();
//             setSportData(data.sports); // Assuming the response includes a sports array
//           } else {
...
//             {/* Sport Dropdown (Populated based on city selection) */}
//             <div>
    ...
    >
      ...
      <div className="pt-16 w-full flex flex-col items-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md mt-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* City Dropdown (with search and toggle) */}
            <div>
              <label className="block text-gray-700">City:</label>
              <Select
                options={cityOptions}
